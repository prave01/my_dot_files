...
function initializeUserSystem() {
    try {
        ...
        if (currentUser && authToken) {
            ...
            initializeApp(); // Only initialize app if user is logged in
        } else {
...
async function refreshInventory() {
    try {
        ...
        inventoryData = data; // Update the global inventoryData
        return data;
    } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    initializeUserSystem(); // This will handle the app initialization if user is logged in
});
